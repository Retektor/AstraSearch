...
- [Архитектура проекта](#рхитектура-проекта)
...
## Описание проекта
AstraSearch представляет из себя веб-приложение, позволяющее искать и читать информацию о небесных телах, добавлять объекты в избранное, а также общаться с единомышленниками.
...
- Spring Boot 4.0.1 – упрощает конфигурацию проекта
...
Перейдите в приложение, подключитесь к БД и используйте Tools > Restore... > Format: Plain > Restore

**Для psql**

Выполните команду `psql -U <пользователь> -d astrasearch -f <путь_к_файлу/dump.sql>`
